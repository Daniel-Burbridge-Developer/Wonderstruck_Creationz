...
const SubCategoryCard = ({ subCategory }) => {
  return (
    <div className="mx-2 w-full max-w-sm overflow-hidden rounded-lg bg-gray-400 bg-opacity-75 shadow-lg">
      ...
      <div className="p-6">
        <Link to={subCategory.url}>
          <h3 className="mb-2 text-xl font-bold">{subCategory.name}</h3>
        </Link>
